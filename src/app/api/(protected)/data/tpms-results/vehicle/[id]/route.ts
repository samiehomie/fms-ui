...
import type { TPMSResultsResponse } from '@/types/features/vehicles/vehicle.types'
    ...
    try {
      ...
      if (!response.success) {
        return createErrorResponse(
          'INTERNAL_ERROR',
          'Failed to fetch TPMS results from external API',
        )
      }
      ...
      return createErrorResponse(
        'INTERNAL_ERROR',
        'An unexpected error occurred while fetching TPMS results',
      )
    }
  })
}
